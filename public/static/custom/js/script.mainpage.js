    ...
    $.ajax({
        ...
        success : function(data){
            if($.isEmptyObject(data)){
                table.html('<tr><td colspan="99">Pas assez de document dans la bibliotheque</td></tr>');
            } else {
                table.html('');
                for(var books in data) {
                    ...
                    if(book.avaliability){
                        book.avaliability = '<a class="btn btn-success">Disponible</a>';
                    } else {
                        book.avaliability = '<a class="btn btn-danger">Non Disponible</a>';
                    }
