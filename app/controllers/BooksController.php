...
class BooksController extends \BaseController {
	...
	public function store()
	{
		...
		DB::transaction( function() use($books) {
			...
			if($db_flag)
				throw new Exception('les information ne sont pas valide');

		});
	
		return "le libre a été ajouter avec success";
	...
	{	
		$issue = Issue::find($id);
		if($issue == NULL){
			throw new Exception('L\'identifient du livre n\'est pas correct');
		}
