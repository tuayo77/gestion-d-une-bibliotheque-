			...
			<div class="module module-login span8 offset2">
				<form class="form-vertical" action="{{ URL::route('student-registration-post') }}" method="POST">
					<div class="module-head">
						<h3>Formulaire d'inscription des étudiants</h3>
					</div>
					...
					<div class="module-foot">
						<div class="control-group">
							<div class="controls clearfix">
								<button type="submit" class="btn btn-info pull-right">S'inscrire à la Bibliothèque</button>
								{{ Form::token() }}
							</div>
						</div>
						<a href="{{ URL::route('account-sign-in') }}">Retourner !</a>
					</div>
				</form>
			</div>
		</div>
